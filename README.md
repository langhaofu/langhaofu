...
**NextLayer Studio 微型 SaaS 产品与大模型探索** | *主理人/全栈开发*
* **项目描述**：探索 AI 大模型落地与软件工具商业化变现的独立实践项目。
* **核心贡献**：在本地算力平台上成功部署开源大模型及 OpenClaw，探索大语言模型在端侧的指令解析与硬件调用；主导开发 Chrome 浏览器扩展工具，打通国际支付闭环，完成从底层逻辑到前端交互及商业化变现的全流程构建。
